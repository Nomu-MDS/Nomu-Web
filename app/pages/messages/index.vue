<template>
  <div class="flex items-center justify-center h-full">
    ...
    <div v-else class="text-center text-[#07172e]/50 px-6">
      ...
      <NuxtLink to="/explore" class="inline-block mt-4 px-5 py-2.5 rounded-full bg-[#07172e] text-white font-[roca] font-bold text-sm no-underline transition-colors hover:bg-[#3a4666]">
        Explorer
      </NuxtLink>
    </div>
  </div>
